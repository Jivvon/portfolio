let resumeData = {
    ...
    "aboutme": "안녕하세요. 주니어 백엔드 개발자 정지원입니다.\n" +
        ...
        "<br>" +
        "2021년에는 JAVA, Spring을 중점적으로 학습할 계획입니다.\n" + 
        "<br>" +
        "<span><span>같이 일하고 싶은, 든든한 개발자</span></span>가 되는 것을 목표로 삼고 있으며 성장하는 느낌이 들 때 가장 행복합니다.",
    "address": "India",
    ...
    "skillsDescription": "Java, Javascript, Python, Flask, Node.js, Redis, RabbitMQ, PostgreSQL, MySQL, React.js, Vue.js, Docker, Git, AWS",
    "skillsCategory": [
        {
            "name": "language",
            "skills": [
    ...
    "experience": [
        {
            "name": "2021 Silicon Valley Online Internship",
